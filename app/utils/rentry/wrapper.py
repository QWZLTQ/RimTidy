    ...
    def show_response_error(self, response: requests.Response) -> None:
        ...
        InformationBox(
            ...
            information=translate(
                "RentryError",
                "RimTidy failed to fetch the content from the provided Rentry link. This may be due to an invalid link, your internet connection, or Rentry.co being down. It may also be the result of a captcha. Please try again later.",
            ),
    ...
    def show_missing_rentry_auth_warning(self) -> None:
        ...
        show_warning(
            ...
            text=translate(
                ...
                "RimTidy can work without rentry auth code. But "
