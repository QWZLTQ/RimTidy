...
class SteamcmdInterface:
    ...
    def download_mods(
        ...
        :param runner: a RimTidy RunnerPanel to interact with
    ...
    def on_steamcmd_not_found(
        ...
        answer = show_dialogue_conditional(
            title=self.translate("SteamcmdInterface", "RimTidy - SteamCMD setup"),
            text=self.translate(
                "SteamcmdInterface",
                "RimTidy was unable to find SteamCMD installed in the configured prefix:\n",
            ),
