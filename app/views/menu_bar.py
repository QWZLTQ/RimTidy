...
class MenuBar(QObject):
    ...
    def _create_file_menu(self) -> QMenu:
        ...
        self.rimsort_shortcuts_submenu = QMenu(self.tr("RimTidy"))
        ...
        # Add actions to RimTidy submenu
    ...
    def _create_help_menu(self) -> QMenu:
        ...
        self.wiki_action = self._add_action(help_menu, self.tr("RimTidy Wiki…"))
        self.github_action = self._add_action(help_menu, self.tr("RimTidy GitHub…"))
