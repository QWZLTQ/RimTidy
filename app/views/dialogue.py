...
def show_internet_connection_error(failed_urls: list[str] | None = None, parent: QWidget | None = None) -> None:
    ...
    show_information(
        ...
        text="RimTidy requires an active internet connection to perform this operation.",
        information=(
            f"{failed_urls_str}\n\n"
            "If you are connected but still see this message, your firewall or security software may be blocking RimTidy. \n"
            "To resolve this issue: \n\n"
            "Add RimTidy to your firewall's allowed applications. \n"
            "You may need to add RimTidy to your firewall's allowed list."
        ),
        details=(
            "On Windows: Open Windows Security > Firewall & network protection > Allow an app through firewall. \n"
            "Find RimTidy or add it manually if needed. \n"
...
class SettingsFailureDialog(QDialog):
    ...
    def __init__(self) -> None:
        ...
        self.close_application_btn = QPushButton(self.tr("Exit RimTidy"))
