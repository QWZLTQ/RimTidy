...
class SettingsDialog(QDialog):
    ...
    def _do_game_launch_tab(self) -> None:
        ...
        self.launch_via_steam_protocol_checkbox.setToolTip(
            self.tr(
                "If enabled, RimTidy will launch the game using the Steam protocol (steam://rungameid/294100) "
    ...
    def _do_backup_settings_group(self, tab_layout: QBoxLayout) -> None:
        ...
        self.backup_saves_on_launch_checkbox.setToolTip(
            self.tr("If enabled, RimTidy will automatically backup saves on the first daily launch.")
        )
...
(This applies to deletion outside of RimTidy too)""")
    ...
    def _do_themes_tab(self) -> None:
        ...
        self.enable_themes_checkbox.setToolTip(
            self.tr(
                ...
                "1) Create a new-folder in 'themes' folder in your 'RimTidy' config folder \n"
                "2) Using the default 'RimPy' theme copy it to the folder you created \n"
                "3) Edit the copied 'style.qss' as per your imagination \n"
                "4) Start 'RimTidy' and select your theme from dropdown \n"
    ...
    def _do_launch_state_tab(self) -> None:
        ...
        user_note = QLabel(self.tr("RimTidy restart required for some settings"))
    ...
    def _do_advanced_tab(self) -> None:
        ...
        self.update_databases_on_startup_checkbox.setToolTip(
            self.tr(
                "Enable this option to automatically update enabled databases when RimTidy starts. "
        ...
        self.enable_backup_before_update_checkbox = QCheckBox(self.tr("Create backup before RimTidy update"))
        self.enable_backup_before_update_checkbox.setToolTip(
            self.tr(
                "Recommended to keep this enabled as it creates a backup before updating RimTidy, "
